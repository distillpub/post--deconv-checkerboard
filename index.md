...
.pattern-examples img.closeup {
  border-radius: 50%;
  margin-bottom: 12px;
}
</style>

<figure class="w-body pattern-examples">
  <div class="example">
    <div class="original">
      <img class="original" src="assets/generated.png">
      <div class="reticle" style="top: 10%; left: 10%; width: 10%; height: 10%;"></div>
    </div>
    <img class="closeup" src="assets/generated-closeup.png">
    <figcaption>
  ...
  <div class="example">
    <div class="original">
      <img class="original" src="assets/generated.png">
      <div class="reticle" style="top: 10%; left: 10%; width: 5%; height: 5%;"></div>
    </div>
    <img class="closeup" src="assets/generated-closeup.png">
    <figcaption>
      <a href="">Blah, et al., 2016</a>
